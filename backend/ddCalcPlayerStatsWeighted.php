<?php
	...
	foreach ($gameList as $key => $val) {
		...
		$thisNewRatings = getNewRatingsWeighted ($thisRatings, $thisGamesPlayed, $thisResults);
	...
	writeArraytoJson($playerStats, "json/ddeloPlayerStatsWeighted.json");


	exit("player stats generated in json/ddeloPlayerStatsWeighted.json");
